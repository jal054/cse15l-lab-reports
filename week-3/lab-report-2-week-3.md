...
1. Lastly we search our database for any string containing a particular string. Most of the strings I added contain **app** so we're going to search for the string **pp**.
